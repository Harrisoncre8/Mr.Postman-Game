...
public class Player : MonoBehaviour {
    ...
    // makes sure player doesn't go faster than max velocity
    ...
    void Update() {
        ...
        if(controller.moving.x != 0){
            if(absVelX < maxVelocity.x){
                ...
                // making sure the air speed is slower than regular speed
                forceX = standing ? newSpeed : (newSpeed * airSpeedMultiplier);
                // turn player sprite around
